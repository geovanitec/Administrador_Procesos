...
namespace Simulacion_Procesos
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
       ...
       private void Btn_Detener_Click(object sender, EventArgs e){
        ...
        private void LblNombreCPU_Click(object sender, EventArgs e)
        {
        ...
        private void LblNombreRam_Click(object sender, EventArgs e)
        {
        ...
        private void LblPorCPU_Click(object sender, EventArgs e)
        {

        }

        private void LblPorRAM_Click(object sender, EventArgs e)
        {

        }

        private void lbl_Contador_Click(object sender, EventArgs e)
        {
